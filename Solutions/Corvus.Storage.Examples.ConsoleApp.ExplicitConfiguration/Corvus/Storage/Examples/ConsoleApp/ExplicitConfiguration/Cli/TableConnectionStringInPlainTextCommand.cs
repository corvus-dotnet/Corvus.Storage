// <copyright file="TableConnectionStringInPlainTextCommand.cs" company="Endjin Limited">
...
/// </summary>
public class TableConnectionStringInPlainTextCommand : UseTableWithAppConfigurationBase
{
    /// <summary>
    /// Creates a <see cref="BlobConnectionStringInPlainTextCommand"/>.
    /// </summary>
    public TableConnectionStringInPlainTextCommand()
    ...
    public class Run : RunBase
    {
        ...
        protected override TableConfiguration GetConfiguration() =>
            this.Configuration.TableStorage.ConnectionStringInConfiguration;
    }
}