// <copyright file="TableConnectionStringInKeyVaultCommand.cs" company="Endjin Limited">
...
/// </summary>
public class TableConnectionStringInKeyVaultCommand : UseTableWithAppConfigurationBase
{
    /// <summary>
    /// Creates a <see cref="BlobConnectionStringInPlainTextCommand"/>.
    /// </summary>
    public TableConnectionStringInKeyVaultCommand()
    ...
    public class Run : RunBase
    {
        ...
        protected override TableConfiguration GetConfiguration() =>
            this.Configuration.TableStorage.ConnectionStringInKeyVault;
    }
}