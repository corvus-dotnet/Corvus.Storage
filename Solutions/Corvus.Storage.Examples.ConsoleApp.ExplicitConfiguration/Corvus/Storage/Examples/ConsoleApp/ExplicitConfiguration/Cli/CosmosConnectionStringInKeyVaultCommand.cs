// <copyright file="CosmosConnectionStringInKeyVaultCommand.cs" company="Endjin Limited">
...
namespace Corvus.Storage.Examples.ConsoleApp.ExplicitConfiguration.Cli
{
    ...
    /// </summary>
    public class CosmosConnectionStringInKeyVaultCommand : UseCosmosWithAppConfigurationBase
    {
        /// <summary>
        /// Creates a <see cref="BlobConnectionStringInPlainTextCommand"/>.
        /// </summary>
        public CosmosConnectionStringInKeyVaultCommand()
        ...
        public class Run : RunBase
        {
            ...
            protected override CosmosContainerConfiguration GetConfiguration() =>
                this.Configuration.Cosmos.ConnectionStringInKeyVault;
        }
    }
}
